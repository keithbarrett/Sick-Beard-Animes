...
class ConfigProviders:
    ...
    def saveProviders(self, nzbmatrix_username=None, nzbmatrix_apikey=None,
                      ...
                      btn_api_key=None,
                      frenchtorrentdb_username=None, frenchtorrentdb_password=None, frenchtorrentdb_user_limit=0,                       
        ...
        for curProviderStr in provider_str_list:
            ...
            elif curProvider == 'frenchtorrentdb':
                sickbeard.FRENCHTORRENTDB = curEnabled
        ...
        sickbeard.FRENCHTORRENTDB_USERNAME = frenchtorrentdb_username
        sickbeard.FRENCHTORRENTDB_PASSWORD = frenchtorrentdb_password
        sickbeard.FRENCHTORRENTDB_USER_LIMIT = int(frenchtorrentdb_user_limit)
